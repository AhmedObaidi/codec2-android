...
namespace com_obteq_android_codec2 {
...
static jlong encode(JNIEnv *env, jclass clazz, jlong n, jshortArray inputBuffer,
...
static jlong decode(JNIEnv *env, jclass clazz, jlong n, jshortArray inputBuffer,
		jcharArray outputBits) {
	int i;
	Context *con = getContext(n);
...
static JNINativeMethod method_table[] = { { "create", "(I)J", (void *) create },
		{ "getSamplesPerFrame", "(J)I", (void *) c2spf }, { "getBitsSize",
				"(J)I", (void *) c2bits },
		{ "destroy", "(J)I", (void *) destroy }, { "encode", "(J[S[C)J",
				(void *) encode }, { "decode", "(J[S[C)J", (void *) decode } };

}

using namespace com_obteq_android_codec2;
...
extern "C" jint JNI_OnLoad(JavaVM* vm, void* reserved) {
	...
	if (vm->GetEnv(reinterpret_cast<void**>(&env), JNI_VERSION_1_6) != JNI_OK) {
		...
		jclass clazz = env->FindClass("com/obteq/android/codec2/Codec2");
		if (clazz) {
